...
export type EngagementForAddNewCohortModalFragment = {
  __typename?: "Engagement";
  id: string;
  startDate?: any | null;
  endDate?: any | null;
...
export type CohortDetailsFragment = {
  __typename?: "Cohort";
  id: string;
  createdAt: any;
  name: string;
 ...
 * });
 */
export function useCohortsPageQuery(
  baseOptions?: Apollo.QueryHookOptions<
    CohortsPageQuery,
    CohortsPageQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<CohortsPageQuery, CohortsPageQueryVariables>(
    CohortsPageDocument,
    options
  );
}
export function useCohortsPageLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    CohortsPageQuery,
    CohortsPageQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<CohortsPageQuery, CohortsPageQueryVariables>(
    CohortsPageDocument,
    options
  );
}
export type CohortsPageQueryHookResult = ReturnType<typeof useCohortsPageQuery>;
export type CohortsPageLazyQueryHookResult = ReturnType<
  typeof useCohortsPageLazyQuery
>;
export type CohortsPageQueryResult = Apollo.QueryResult<
  CohortsPageQuery,
  CohortsPageQueryVariables
>;
